...
/* package x02-linear-0.1.0.0 */
#define VERSION_x02_linear "0.1.0.0"
#define MIN_VERSION_x02_linear(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "x02-linear-0.1.0.0"

#define CURRENT_PACKAGE_KEY "x02-linear-0.1.0.0"
