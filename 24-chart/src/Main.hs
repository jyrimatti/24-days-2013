...
main =
  ...
  in do
       renderableToFile def "up-down.png" (toRenderable upDown)
       renderableToFile def "upvotes-pie.png" (toRenderable upVotesPie)
       renderableToFile def "upvotes-comments.png" (toRenderable upVotesComments)